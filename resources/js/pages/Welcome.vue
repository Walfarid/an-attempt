    ...
    for (const skill of skills) {
        if (!seen.has(skill.category)) {
            ...
            groups.push({
                ...
                skills: skills.filter((s) => s.category === skill.category),
            });
        }
    }
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <div>
                            <p
                                class="d-section hero-tagline mb-4"
                            ...
                            />
                            <div
                                class="hero-cta mt-8 flex flex-wrap gap-3"
                                style="visibility: hidden"
                            >
                                <a
                                    href="#projects"
                                    class="inline-flex min-h-11 items-center gap-2 bg-(--accent) px-6 py-3 text-sm font-semibold text-(--paper) no-underline transition-colors hover:bg-(--accent-hover)"
                                >
                                    View work
                                    <ArrowUpRight
                                        class="size-4"
                                ...
                                <a
                                    href="#contact"
                                    class="d-surface d-hover inline-flex min-h-11 items-center gap-2 px-6 py-3 text-sm font-semibold no-underline"
                                >
                                    Get in touch
                                </a>
                            </div>
            ...
            >
                <div class="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
                    <div class="mb-10 max-w-2xl" data-motion>
                        ...
                        >
                            Grouped so you don't have to scroll through a wall
                            of text. Tap a category to see what's inside.
                        </p>
                    </div>
                            ...
                            <div class="flex flex-1 flex-col gap-3 p-5 sm:p-6">
                                ...
                                >
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noreferrer noopener"
                                        class="inline-flex min-h-9 items-center gap-1.5 bg-(--accent) px-4 py-1.5 text-xs font-semibold text-(--paper) no-underline transition-colors hover:bg-(--accent-hover)"
                                    >
                                        Live site
                                        <ArrowUpRight
                                            class="size-3.5"
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noreferrer noopener"
                                        class="d-hover inline-flex min-h-9 items-center gap-1.5 px-4 py-1.5 text-xs font-semibold no-underline"
                                    >
                                        Source
                                        <ExternalLink
                                            class="size-3.5"
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            class="mt-1 inline-flex min-h-11 items-center justify-center gap-2 bg-(--accent) px-6 py-2.5 text-sm font-semibold text-(--paper) transition-colors hover:bg-(--accent-hover) disabled:pointer-events-none disabled:opacity-50"
                            :disabled="processing"
                        >
                            Send message
                            <ArrowUpRight class="size-4" aria-hidden="true" />
